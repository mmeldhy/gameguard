          ...
          <div className="container px-4 md:px-6">
            <div className="mx-auto grid max-w-5xl items-center gap-6 lg:grid-cols-2 lg:gap-12">
              ...
              <div className="space-y-4">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Delta Additive Method</h2>
                <p className="text-muted-foreground md:text-lg">
                  The Delta Additive method embeds watermarks by adding small delta values to vertex coordinates. This
                  approach provides a balance between watermark invisibility and extraction reliability.
                </p>
              </div>
            </div>
          </div>
